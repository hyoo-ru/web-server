...
(function ($) {
    class $hyoo_sync_watch_world extends $mol_book2_catalog {
        ...
        Node(id) {
            ...
            obj.body = () => [
                this.Node_output_content(id)
            ];
            return obj;
        }
        Node_output_switch(id) {
            return this.Node_output(id).Switch();
        }
        Node_output_content(id) {
            return this.Node_output(id).Content();
        }
        Node_output(id) {
        ...
        Node_units(id) {
            const obj = new this.$.$mol_grid();
            obj.title = () => "Units";
            obj.records = () => this.node_units(id);
            return obj;
        }
        node_list(id) {
            return [];
...
(function ($) {
    class $hyoo_sync_watch_log extends $mol_page {
        ...
        Row_field_moment(id) {
            ...
            obj.value_moment = () => this.row_field_moment(id);
            return obj;
        }
        Row_field_text(id) {
            const obj = new this.$.$mol_text_code();
            obj.text = () => this.row_field_text(id);
            return obj;
        }
        Row_field_land(id) {
            const obj = new this.$.$mol_link();
            ...
            obj.sub = () => [
                this.Row_field_ava(id),
                this.row_field_text(id)
            ];
            return obj;
        }
        types() {
        ...
        Filter_type() {
            ...
            obj.keys = () => this.types();
            obj.option_title = (id) => this.type_label(id);
            obj.option_checked = (id, next) => this.type_visible(id, next);
            return obj;
        }
        row_type(id) {
            return "";
        ...
        Row_field(id) {
            const obj = new this.$.$mol_labeler();
            obj.title = () => this.row_field_name(id);
            obj.Content = () => this.Row_field_value(id);
            return obj;
        }
        row_content(id) {
            return [
        ...
        Row_field_ava(id) {
            const obj = new this.$.$mol_avatar();
            obj.id = () => this.row_field_text(id);
            return obj;
        }
    }
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_field_moment", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_field_text", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_field_land", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "type_visible", null);
    __decorate([
        $mol_mem
    ], $hyoo_sync_watch_log.prototype, "Filter_type", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_type", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_field_value", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_field", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row", null);
    __decorate([
        $mol_mem
    ], $hyoo_sync_watch_log.prototype, "Rows", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "row_field_moment", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_sync_watch_log.prototype, "Row_field_ava", null);
    $.$hyoo_sync_watch_log = $hyoo_sync_watch_log;
})($ || ($ = {}));
//hyoo/sync/watch/log/-view.tree/log.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_sync_watch_log.prototype, "source", null);
        __decorate([
            $mol_mem
        ], $hyoo_sync_watch_log.prototype, "types", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_sync_watch_log.prototype, "type_label", null);
        __decorate([
            $mol_mem
        ], $hyoo_sync_watch_log.prototype, "items", null);
        __decorate([
            $mol_mem
        ], $hyoo_sync_watch_log.prototype, "fields", null);
        __decorate([
            $mol_mem
        ], $hyoo_sync_watch_log.prototype, "rows", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_sync_watch_log.prototype, "row_fields", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_sync_watch_log.prototype, "row_content", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_sync_watch_log.prototype, "Row_field_value", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_sync_watch_log.prototype, "row_field_tree", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_sync_watch_log.prototype, "row_field_moment", null);
        __decorate([
...
//hyoo/sync/watch/log/log.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $hyoo_sync_watch extends $mol_book2_catalog {
        ...
        Sources() {
            ...
            obj.uri = () => "https://github.com/hyoo-ru/sync.hyoo.ru";
            return obj;
        }
        yard() {
            const obj = new this.$.$hyoo_sync_client();
        ...
        Log() {
            const obj = new this.$.$hyoo_sync_watch_log();
            obj.tools = () => [
                this.Spread_close()
            ];
            return obj;
    ...
    __decorate([
        $mol_mem
    ], $hyoo_sync_watch.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $hyoo_sync_watch.prototype, "Lights", null);
    __decorate([
        $mol_mem
    ], $hyoo_sync_watch.prototype, "Sources", null);
    __decorate([
        $mol_mem
    ], $hyoo_sync_watch.prototype, "yard", null);
    __decorate([
        $mol_mem
    ...
    $.$hyoo_sync_watch = $hyoo_sync_watch;
})($ || ($ = {}));
//hyoo/sync/watch/-view.tree/watch.view.tree.ts
;
"use strict";
var $;
(function ($) {
